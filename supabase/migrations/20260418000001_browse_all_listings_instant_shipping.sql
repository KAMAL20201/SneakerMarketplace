-- Add p_instant_shipping filter to browse_all_listings.
-- When true, restricts results to listings whose delivery_days minimum < 10,
-- matching the instant_shipping_with_images view definition.
...
BEGIN
  ...
  WITH base AS (
    ...
    WHERE l.status = 'active'
      ...
      -- instant shipping: delivery_days minimum < 10 (mirrors instant_shipping_with_images view)
