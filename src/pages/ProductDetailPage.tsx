    ...
    <div className="min-h-screen">
      ...
      <div className="lg:flex lg:gap-8 lg:p-8">
        ...
        <div className="lg:w-[40%] lg:pt-6">
          ...
          {isPreOrderProduct ? (
            /* ── Pre-order: WhatsApp size check + single full-width button ── */
            <div className="px-4 pb-6 lg:px-0 space-y-3">
              {/* WhatsApp size availability confirmation banner */}
              {!isSoldOut && (
                <a
                  ...
                  className="flex items-center gap-3 rounded-2xl border border-green-200 bg-green-50 px-4 py-3 transition-colors hover:bg-green-100 group"
                >
                  {/* WhatsApp icon */}
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-sm group-hover:scale-105 transition-transform">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-green-800">Confirm size availability on WhatsApp</p>
                    <p className="text-xs text-green-600 mt-0.5">
                      Message us to verify your size is in stock before placing your pre-order
                    </p>
                  </div>
                  <svg className="h-4 w-4 text-green-400 shrink-0 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
