...
export function meta(_: Route.MetaArgs) {
  return [
    ...
    },
    {
      tagName: "link",
      rel: "canonical",
      href: "https://theplugmarket.in/blog",
    },
    {
      property: "og:title",
      content: "Blog — The Plug Market | Sneaker Culture, Guides & Drops",
    },
    {
      ...
      <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 text-white py-14 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-base md:text-lg max-w-xl mx-auto">
            Sneaker history, cop guides, authentication tips &amp; culture drops
            — all from India's most trusted sneaker market.
          </p>
        </div>
      </div>
