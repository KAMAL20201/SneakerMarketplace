export const ROUTE_NAMES = {
  ...
  ADMIN_NEW_DROPS: "/admin/new-drops",
  ADMIN_HOT_DEALS: "/admin/hot-deals",
  ADMIN_RUNNING_SNEAKERS: "/admin/running-sneakers",
...
export const ROUTE_HELPERS = {
  ...
  SALE_PAGE: (slug: string) => `/sale/${slug}`,
  ADMIN_SALE_PRODUCTS: (bannerId: string) => `/admin/sale-products/${bannerId}`,
} as const;
